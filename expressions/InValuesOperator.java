...
public class InValuesOperator extends Expression {
    ...
    /**
     * If this is false, the operator computes <tt>expr IN (values)</tt>;
     * if true, the operator computes <tt>expr NOT IN (values)</tt>.
     */
    ...
    public Object evaluate(Environment env) throws ExpressionException {
        ...
        // If we didn't find a matching value, and the array contains a NULL
        // value, the SQL standard says we need to return NULL, not FALSE.
        if (!result && rhsNull)
            return null;
