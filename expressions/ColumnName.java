...
public class ColumnName implements Comparable<ColumnName>, Cloneable {
     ...
     * with.  If this value is {@code null} then the table name is not
     * specified.
     */
    ...
    /**
     * The name of the column, or if this value is {@code null} then it
     * represents a wildcard value <tt>*</tt>.
     */
    ...
    public ColumnName(String tableName, String columnName) {
        if ("*".equals(columnName)) {
            ...
            throw new IllegalArgumentException(
                "Wildcard column names are represented with null, not \"*\"");
        }
