...
public class CompareOperator extends Expression {
    ...
    public enum Type {
        ...
        /**
         * Given a string representation of a compare operator, this method
         * returns the corresponding {@code Type} value.  Besides the string
         * representations specified in the enum, the "=" and "&lt;&gt;"
    ...
    public Object evaluate(Environment env) throws ExpressionException {
        ...
        Pair coerced = TypeConverter.coerceComparison(lhsValue, rhsValue);
    ...
    /**
     * Normalize the comparison expression.  The rules are:
     * <ul>
     *   <li>Comparisons with a column-name and a literal value will be
     *       updated so that the literal value is always on the right.</li>
     *   <li>Comparisons with two column-names will be updated so that the
     *       left column-name is "less than" the right column-name, using the
     *       {@link ColumnName#compareTo} method.</li>
     * </ul>
     */
    ...
    public static boolean areObjectsEqual(Object obj1, Object obj2) {
        Pair pair = TypeConverter.coerceComparison(obj1, obj2);
