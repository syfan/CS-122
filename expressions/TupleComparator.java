...
public class TupleComparator implements Comparator<Tuple> {
    ...
    public TupleComparator(Schema schema, List<OrderByExpression> orderSpec) {
        ...
        this.schema = schema;
        this.orderSpec = new ArrayList<>(orderSpec);
    }
    ...
    private static int _compareTuples(Tuple t1, Tuple t2,
        ...
        while (i < compareCols && compareResult == 0) {
            ...
            Pair p = TypeConverter.coerceComparison(objA, objB);
            Comparable valueA = (Comparable) p.value1;
            Comparable valueB = (Comparable) p.value2;
