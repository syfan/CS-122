...
public class LogSequenceNumber
    ...
    public LogSequenceNumber(int logFileNo, int fileOffset, int recordSize) {
        ...
        if (recordSize < 0)
            throw new IllegalArgumentException("Record size must be nonnegative");
    ...
    public LogSequenceNumber(int logFileNo, int fileOffset) {
        // Pass 0 for record size.
        this(logFileNo, fileOffset, 0);
    }
    ...
    public LogSequenceNumber(LogSequenceNumber lsn, int recordSize) {
        ...
        this.logFileNo = lsn.logFileNo;
        this.fileOffset = lsn.fileOffset;
        this.recordSize = recordSize;
    }
