 ...
 * This second part is included as values in this class.  The two parts
 * together represent the type of a particular attribute.
 */
public class ColumnType implements Serializable {

    public static final int DEFAULT_PRECISION = 36;
    public static final int DEFAULT_SCALE = 0;

    public static final ColumnType INTEGER = new ColumnType(SQLDataType.INTEGER);

    public static final ColumnType SMALLINT = new ColumnType(SQLDataType.SMALLINT);

    public static final ColumnType BIGINT = new ColumnType(SQLDataType.BIGINT);

    public static final ColumnType TINYINT = new ColumnType(SQLDataType.TINYINT);

    public static final ColumnType FLOAT = new ColumnType(SQLDataType.FLOAT);

    public static final ColumnType DOUBLE = new ColumnType(SQLDataType.DOUBLE);

    public static final ColumnType DATE = new ColumnType(SQLDataType.DATE);

    public static final ColumnType TIME = new ColumnType(SQLDataType.TIME);

    public static final ColumnType DATETIME = new ColumnType(SQLDataType.DATETIME);

    public static final ColumnType TIMESTAMP = new ColumnType(SQLDataType.TIMESTAMP);

    public static final ColumnType FILE_POINTER = new ColumnType(SQLDataType.FILE_POINTER);

    public static ColumnType VARCHAR(int length) {
        ColumnType t = new ColumnType(SQLDataType.VARCHAR);
        t.setLength(length);
        return t;
    }

    public static ColumnType CHAR(int length) {
        ColumnType t = new ColumnType(SQLDataType.CHAR);
        t.setLength(length);
        return t;
    }

    public static ColumnType NUMERIC() {
        return new ColumnType(SQLDataType.NUMERIC);
    }


    public static ColumnType NUMERIC(int precision) {
        ColumnType t = new ColumnType(SQLDataType.NUMERIC);
     ...
     * <p>
     * The default precision value used is {@link #DEFAULT_PRECISION}.
     */
